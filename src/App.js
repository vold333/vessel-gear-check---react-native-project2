...
const AuthStack = () => (
  <Stack.Navigator initialRouteName="Landing">
    ...
    <Stack.Screen name="Verify" component={VerifyScreen} options={{ headerTransparent: true, headerTintColor: 'white' }} />
    <Stack.Screen name="NewPassword" component={NewPasswordScreen} options={{ headerTransparent: true, headerTintColor: 'white' }} />
  </Stack.Navigator>
);
...
const DashboardDrawer = () => (
  <Drawer.Navigator initialRouteName="Home" drawerContent={DrawerContent}>
    <Drawer.Screen name="Home" component={Dashboard} options={{ headerStyle: { backgroundColor: '#333' }, headerTintColor: '#fff' }} />
